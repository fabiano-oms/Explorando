...
namespace Explorando.Controllers {
    public class CodigoSondaController {
        ...
        public void PosicaoInicialAlpha () {
            ...
            System.Console.Write("Direção: ");
            sondaAlpha.direcao = Console.ReadLine(); 
        }
        ...
        public void PosicaoInicialBeta () {
            ...
            System.Console.Write("Direção: ");
            sondaBeta.direcao = Console.ReadLine(); 
        }
        ...
        public void ComandoMovimentoAlpha () {
            ...
            string comandosAlpha = Console.ReadLine();
        ...
        public void ComandoMovimentoBeta () {
            ...
            System.Console.Write("Input: ");
            string comandosBeta = Console.ReadLine();
        ...
        _config.posicaoFinalAlpha = $"Posição final da sonda Alpha: {sondaAlpha.posicaoX.ToString()} {sondaAlpha.posicaoY.ToString()} {sondaAlpha.direcao.ToString()}";
        }
        ...
        _config.posicaoFinalBeta = $"Posição final da sonda Beta: {sondaBeta.posicaoX.ToString()} {sondaBeta.posicaoY.ToString()} {sondaBeta.direcao.ToString()}";
        }
    }
}